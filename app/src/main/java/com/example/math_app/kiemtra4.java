...
public class kiemtra4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!checkClick){
                    Toast.makeText(kiemtra4.this,"Chưa chọn đáp án", Toast.LENGTH_SHORT).show();
                }
                if(checkClick){
    ...
    private void dialog(){
        ...
        bt_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(kiemtra4.this, menu.class));
            }
        });
        dialog.show();
    }
    private void ExamData(){
        databaseReference.child("chude4").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void startTime(){
        countDownTimer = new CountDownTimer(time, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(kiemtra4.this, "Hết thời gian!", Toast.LENGTH_SHORT).show();
                dialog();
            }
        };
