...
public class Tinhnham {
    private String noidung, hinhanh,dapan, dapan1, dapan2, dapan3, dapan4;
    ...
    public Tinhnham(String noidung, String hinhanh, String dapan, String dapan1, String dapan2, String dapan3, String dapan4) {
        this.noidung = noidung;
        this.hinhanh = hinhanh;
        this.dapan = dapan;
        this.dapan1 = dapan1;
